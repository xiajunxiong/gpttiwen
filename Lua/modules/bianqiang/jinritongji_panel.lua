JinRiTongJiPanel = JinRiTongJiPanel or DeclareMono("JinRiTongJiPanel", UIWFlushPanel)
function JinRiTongJiPanel:JinRiTongJiPanel()
    self.data_cares = {
        {data = BianQiangData.Instance.income_info, func = self.FlushView, init_call = false},
        {data = RoleData.Instance.base_data, func = self.FlushScore, keys={"capability"}},
    }
    BianQiangCtrl.Instance:SendRoleInfo()
end

function JinRiTongJiPanel:Awake()
    UIWFlushPanel.Awake(self)
    self:FlushView()
end

function JinRiTongJiPanel:OnDestroy()
    UIWFlushPanel.OnDestroy(self)
end

function JinRiTongJiPanel:FlushView()
...
function JinRiTongJiPanel:FlushScore()
    if self.Score then
