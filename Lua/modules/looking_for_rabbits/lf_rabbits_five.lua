LookingForRabbits5 = LookingForRabbits5 or DeclareMono('LookingForRabbits5', UIWFlushPanel)
function LookingForRabbits5:LookingForRabbits5()
...
function LookingForRabbits5:Awake()
    self.Root:SetActive(false)
    UIWFlushPanel.Awake(self)
    self:CheckRabbit()
end

function LookingForRabbits5:Prepare()
...
function LookingForRabbits5:HasRabbit(idx, final)
...
function LookingForRabbits5:SetRabbitPos(idx, pos_idx, show)
...
function LookingForRabbits5:CheckRabbit()
...
function LookingForRabbits5:OnEnable()
    self:CheckRabbit()
    UIWFlushPanel.OnEnable(self)
end
function LookingForRabbits5:OnDestroy()
...
function LookingForRabbits5:StartChange()
    local level_info = self.data:LevelCfg()
...
function LookingForRabbits5:StartPlay()
    self.play_num = 1
...
function LookingForRabbits5:Show(idx, show)
    self.ShowList[idx]:SetActive(show)
end
function LookingForRabbits5:Boom(idx, boom)
    self.BoomList[idx]:SetActive(false)
    self.BoomList[idx]:SetActive(boom)
end

function LookingForRabbits5:PlayAnim()
...
function LookingForRabbits5:AnimaEnd(a, b)
...
function LookingForRabbits5:PlayEnd()
    for i = 1, self.ShowList:Length() do
        self:Show(i, true)
    end
...
function LookingForRabbits5:SelectEnd()
    -- 打开兔子关闭特效
end
