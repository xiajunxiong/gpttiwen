LookingForRabbits3 = LookingForRabbits3 or DeclareMono('LookingForRabbits3', UIWFlushPanel)
function LookingForRabbits3:LookingForRabbits3()
...
function LookingForRabbits3:Awake()
    self.Root:SetActive(false)
    UIWFlushPanel.Awake(self)
    self:CheckRabbit()
end
function LookingForRabbits3:HasRabbit(idx, final)
...
function LookingForRabbits3:Prepare()
...
function LookingForRabbits3:SetRabbitPos(idx, pos_idx, show)
...
function LookingForRabbits3:CheckRabbit()
...
function LookingForRabbits3:OnEnable()
    self:CheckRabbit()
    UIWFlushPanel.OnEnable(self)
end
function LookingForRabbits3:OnDestroy()
...
function LookingForRabbits3:StartChange()
    local level_info = self.data:LevelCfg()
...
function LookingForRabbits3:StartPlay()
    self.play_num = 1
...
function LookingForRabbits3:Show(idx, show)
    self.ShowList[idx]:SetActive(show)
end
function LookingForRabbits3:Boom(idx, boom)
    self.BoomList[idx]:SetActive(false)
    self.BoomList[idx]:SetActive(boom)
end
function LookingForRabbits3:PlayAnim()
...
function LookingForRabbits3:AnimaEnd(a, b)
    self:Show(a, true)
    self:Show(b, true)
...
function LookingForRabbits3:PlayEnd()
...
function LookingForRabbits3:SelectEnd()
    -- 打开兔子关闭特效
end
