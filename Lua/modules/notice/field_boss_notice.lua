FieldBossNotice = FieldBossNotice or DeclareView("FieldBossNotice", "notice/fight_field_boss_notice", Mod.FunOpenNotice.FieldBoss)

VIEW_DECLARE_LEVEL(FieldBossNotice, ViewLevel.L1)

FieldBossNoticePanel = FieldBossNoticePanel or DeclareMono("FieldBossNoticePanel", UIWFlushPanel)

function FieldBossNoticePanel:onFlush()
    self.config = GuideData.Instance:GetFunctionNoticeData(Mod.FunOpenNotice.FieldBoss)
...
function FieldBossNoticePanel:OnClickClose()
    ViewMgr:CloseView(FieldBossNotice)
end

function FieldBossNoticePanel:OnClickGet()
    local flag = GuideData.Instance:NoticeInfo(self.config.notice_id)
...
-- 规则：任务完成后显示开启奖励
function FieldBossNoticePanel:FlushGuideUnit()
