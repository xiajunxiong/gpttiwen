SanXianGuiDong4 = SanXianGuiDong4 or DeclareMono('SanXianGuiDong4', UIWFlushPanel)
function SanXianGuiDong4:SanXianGuiDong4()
...
function SanXianGuiDong4:Awake()
    self.Root:SetActive(false)
    UIWFlushPanel.Awake(self)
    self:CheckRabbit()
end

function SanXianGuiDong4:Prepare()
...
function SanXianGuiDong4:HasRabbit(idx, final)
...
function SanXianGuiDong4:SetRabbitPos(idx, pos_idx, show)
...
function SanXianGuiDong4:CheckRabbit()
...
function SanXianGuiDong4:OnEnable()
    self:CheckRabbit()
    UIWFlushPanel.OnEnable(self)
end
function SanXianGuiDong4:OnDestroy()
...
function SanXianGuiDong4:StartChange()
    local level_info = self.data:LevelCfg()
...
function SanXianGuiDong4:StartPlay()
    self.play_num = 1
...
function SanXianGuiDong4:Show(idx, show)
    self.ShowList[idx]:SetActive(show)
end
function SanXianGuiDong4:Boom(idx, boom)
    self.BoomList[idx]:SetActive(false)
    self.BoomList[idx]:SetActive(boom)
end
function SanXianGuiDong4:PlayAnim()
...
function SanXianGuiDong4:AnimaEnd(a, b, c, d)
...
function SanXianGuiDong4:PlayEnd()
    for i = 1, self.ShowList:Length() do
        self:Show(i, true)
    end
...
function SanXianGuiDong4:SelectEnd()
    -- 打开兔子关闭特效
end
