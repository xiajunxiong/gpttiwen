...
#include "bbl_impl_world_boss2.hpp"

BBLImplWorldBoss2::BBLImplWorldBoss2()
{
...
void BBLImplWorldBoss2::OnBattleFinish(battlegameprotocol::BattleGameFightResultAck* ack)
{
	...
	Protocol::SCWorldBoss2BattleInfo protocol;
...
void BBLImplWorldBoss2::OnBattleForceFinish(battlegameprotocol::BattleGameForceFinishFight * ack)
{
	// 触发这里表明boss已被打死，
	// 更新伤害排行榜
	ActivityWorldBoss2* act = static_cast<ActivityWorldBoss2*>(ActivityManager::Instance().ForceGetActivity(ACTIVITY_TYPE_WORLD_BOSS_2));
