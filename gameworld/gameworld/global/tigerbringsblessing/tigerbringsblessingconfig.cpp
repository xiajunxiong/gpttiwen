#include "tigerbringsblessingconfig.hpp"

TigerBringsBlessingConfig::TigerBringsBlessingConfig()
{
...
bool TigerBringsBlessingConfig::Init(const std::string & configname, std::string * err)
{
	PRE_LOAD_CONFIG;

	LOAD_CONFIG_2("basic_configuration", InitOtherCfg);

	return true;
}

int TigerBringsBlessingConfig::InitOtherCfg(TiXmlElement * RootElement, std::string& errormsg)
{
