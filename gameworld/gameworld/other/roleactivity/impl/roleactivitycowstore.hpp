#ifndef __ROLE_ACTIVITY_COW_STORE_HPP__
#define __ROLE_ACTIVITY_COW_STORE_HPP__

#include "other/roleactivity/roleactivity.hpp"
#include "servercommon/roleactivity/racowparam.hpp"

class RoleActivityCowStore : public RoleActivity
{
public:
	RoleActivityCowStore(int type);
	virtual ~RoleActivityCowStore();
