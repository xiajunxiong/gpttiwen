#ifndef __ROLE_ACTIVITY_SHANHAI_MI_BAO_HPP__
#define __ROLE_ACTIVITY_SHANHAI_MI_BAO_HPP__

#include "other/roleactivity/roleactivity.hpp"
#include "servercommon/roleactivity/racoolsummerparam.hpp"

class RoleActivityShanHaiMiBao : public RoleActivity
{
public:
	RoleActivityShanHaiMiBao(int type);
	virtual ~RoleActivityShanHaiMiBao();
