#ifndef __ROLE_ACTIVITY_SUMMER_LI_LIAN_HPP__
#define __ROLE_ACTIVITY_SUMMER_LI_LIAN_HPP__

#include "other/roleactivity/roleactivity.hpp"
#include "servercommon/roleactivity/raburningsummerparam.hpp"

class RoleActivitySummerLiLian : public RoleActivity
{
public:
	RoleActivitySummerLiLian(int type);
	virtual ~RoleActivitySummerLiLian();
