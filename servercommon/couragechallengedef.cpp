#include "couragechallengedef.hpp"
#include "common/tlvprotocol.h"

bool RoleCourageChallengeLevelParamList::Serialize(TLVSerializer & outstream) const
{
	...
	for (int i = 0; i < count && i < MAX_COURAGE_CHALLENGE_LEVEL_NUM; ++i)
	{
...
bool RoleCourageChallengeLevelParamList::Unserialize(TLVUnserializer & instream)
{
