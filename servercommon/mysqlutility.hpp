...
public:
	...
	static int ExecSelect(TMysqlStatement *pstMysqlStat, int* iErrNo, char *sErrMsg, int iErrMsgBufferSize);
	//static int RealUpdate(TMysqlStatement *pstMysqlStat, int* iErrNo, char *sErrMsg);

	static int SetCharSet(TMysqlStatement *pstMysqlStat, int* iErrNo, char *sErrMsg, char *pcCharSet = "utf8");
};
