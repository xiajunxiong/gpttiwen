...
{
public:
	DBServerAddr():DBRoleCount(1),IsDelayLoad(true),
...
// 各表
class DBTableServerAddr :public ConfigElementBase
{
public:
	DBTableServerAddr() :NoCacheTables(),NoDelayTables(){}
	virtual ~DBTableServerAddr() {}
...
{
public:
	LoginServerInnerAddr():server_ip("127.0.0.1"),for_global(false),for_gameserver(false),for_gateway(false),for_battle(false){}
...
// 战斗服务器地址
class BattleServerAddr : public ConfigElementBase
{
public:
	BattleServerAddr() {}
	virtual ~BattleServerAddr() {}
...
// 服务端各表
class DBTablesConfig :public ConfigElementBase
{
public:
	DBTablesConfig() :db_server_addr(),m_document() {}
	...
	DBTableServerAddr db_server_addr;
...
public:
	ServerTimeOut():is_check_timeout(true),check_timeout_interval_ms(1000),
		...
		login_server_max_server_time_ms(1000), battle_server_heartbeat_dead_time_ms(1000) {}
	...
	unsigned int battle_server_heartbeat_dead_time_ms;
};
...
public:
	...
	bool LoadConfig(const std::string &config_path,char *err_info);
