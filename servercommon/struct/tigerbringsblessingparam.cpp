#include "tigerbringsblessingparam.hpp"
#include "servercommon/struct/structcommon.h"

bool TigerBringsBlessingBuyListParam::Serialize(TLVSerializer &outstream) const
{
	...
	for (int i = 0; i < count && i < MAX_ONCE_TIGER_BRINGS_BLESSING_COUNT; ++i)
	{
...
bool TigerBringsBlessingBuyListParam::Unserialize(TLVUnserializer &instream)
{
